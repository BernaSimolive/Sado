...
public class TelaHistorico extends javax.swing.JFrame {
    ...
    public void listar(){
        try {
            ...
            List<Doacao> listaDoacoes = doacaoDB.listarDoacoes();
    ...
    private void initComponents() {
        ...
        botaoHistoricoHub.setFont(new java.awt.Font("Microsoft JhengHei UI", 1, 20)); // NOI18N
        botaoHistoricoHub.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        botaoHistoricoHub.setText("Histórico");
        botaoHistoricoHub.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        botaoHistoricoHub.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jLabel8.setText("Histórico de Doações");

        tabelaHistorico.setFont(new java.awt.Font("Microsoft YaHei", 0, 11)); // NOI18N
        tabelaHistorico.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null, null, null}
            },
            new String [] {
                "cpfDoador", "idDoação", "Alimento", "Quantidade", "Peso", "Descrição"
            }
        ) {
        ...
        tabelaHistorico.setGridColor(new java.awt.Color(0, 0, 0));
